        ...
        <div className="flex lg:flex-row  flex-col pt-4 pl-4 pr-4  ">
          <div className="lg:w-1/2 lg:mr-10 w-full ">
            ...
            <Link href="/nutrition/recipes" >
              ...
              duration-300 ease-in-out hover:bg-custom-purple4 cursor-pointer'>
          ...
          <div className="lg:w-1/2 w-full">
            ...
            <div className="flex justify-between px-4 lg:py-2.5 z-10  md:py-2.5 py-2
             bg-custom-purple3 lg:rounded-2xl  md:rounded-2xl rounded-full lg:w-[340px] sm:w-[330px]  w-[240px] mt-4 
             lg:mt-0 transition-colors duration-300 ease-in-out hover:bg-custom-purple4 cursor-pointer">
            ...
            mt-7 transition-colors duration-300 ease-in-out hover:bg-custom-purple4 cursor-pointer">
              <h3 className="pt-1 pl-2 text-white font-bold lg:text-3xl text-xl w-[240px] ">
                Mis porciones
              </h3>
            ...
            <Link href="/nutrition/imageDetection">
              ...
              transition-colors duration-300 ease-in-out hover:bg-custom-purple4">
                <h3 className='pt-1 pl-2 text-white font-bold lg:text-3xl text-xl w-[240px] cursor-pointer'>
