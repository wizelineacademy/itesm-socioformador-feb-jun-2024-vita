...
const ExerciseSelection = () => {
    ...
    return (
        <div className="ml-5 mr-5">
            ...
            <div className="w-full mt-5 mb-10 flex flex-col justify-around md:flex-row md:flex-wrap lg:gap-x-3 md:justify-center md:items-center lg:w-1/2 lg:mx-auto lg:gap-y-5">
                {data.map(el => (
                    <div 
                        key={el.name}
                        onClick={() => {
                        ...
                        className="w-5/6 mt-5 px-5 py-2 mx-auto rounded-3xl flex justify-between items-center text-white font-medium bg-mid-green hover:cursor-pointer hover:bg-dark-green md:w-2/5 md:flex-col-reverse md:items-start md:justify-start md:h-56 lg:w-5/12 lg:h-64 lg:max-w-[300px]"
                    >
                    <p className="text-lg font-bold md:text-xl md:mt-6 md:mb-10">{el.name}</p>
