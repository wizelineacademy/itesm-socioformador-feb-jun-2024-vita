        ...
        <form>
          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-row w-1/2">
              ...
              <select name="sex" className="text-2xl py-2 px-6 rounded-full text-white bg-reminders-input w-60 mt-4" required>
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            ...
            <div className="flex flex-row  justify-between lg:gap-16">
              ...
              <div className="flex flex-col mt-4">
                <h2 className="text-2xl text-white mb-4">Fecha Fin</h2>
                <input type="time" name="weight"
                 placeholder="0" className="text-2xl py-2 px-6 rounded-full text-white bg-reminders-input w-40" min="1" required />
              </div>
            </div>
          </div>
