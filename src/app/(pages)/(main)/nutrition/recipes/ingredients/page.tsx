...
const RecipesIngredients = () => {
  ...
  const generatePrompt = () => {
    ...
    if (excludedIngredients) {
      prompt +=
        '. Excluye las recetas que contengan los siguentes ingredientes: '
  ...
  return (
    <div className='ml-5 mr-5'>
      ...
      <h3 className={'mt-5 text-xl text-white md:w-4/5 lg:w-3/5'}>
        Selecciona los ingredientes que deseas incluir o excluir de las recetas
      </h3>
      <div className='mt-10 flex justify-around lg:justify-start'>
        <button
          ...
          className={cn(
            'z-10 w-2/5 max-w-72 rounded-3xl px-7 py-3 text-center font-semibold text-white hover:bg-decoration-nutrition-colordark',
            {
        ...
        <button
          ...
          className={cn(
            'z-10 w-2/5 max-w-72 rounded-3xl px-7 py-3 text-center font-semibold text-white hover:bg-decoration-nutrition-colordark lg:ml-10',
            {
      ...
      <div className='mx-auto mt-10 flex w-4/5 max-w-[650px] rounded-3xl bg-custom-extralightpurple px-5 py-3 lg:ml-0'>
        <input
          id='listIngredients'
          placeholder='Ingrediente'
          className='w-4/5 border-none bg-custom-extralightpurple text-white placeholder-gray-300 outline-none'
          type='text'
          list='ingredients'
          value={selectedList === 0 ? addedIngredient : excludedIngredient}
          onChange={(e) => {
            selectedList === 0
              ? setAddedIngredient(e.target.value)
              : setExcludedIngredient(e.target.value)
          }}
        />
        ...
        <button
          ...
          className='z-10 mr-5 w-1/5 font-semibold text-white hover:text-gray-300'
        >
          Agregar
        </button>
      </div>
      <ul className='mx-auto mb-10 mt-10 flex flex-wrap content-start rounded-2xl bg-dark-background-purple pb-10 pt-7 md:w-full lg:ml-0 lg:w-4/5 lg:max-w-[750px]'>
        {selectedList === 0
      ...
      <div className='flex 2xl:w-[1050px]'>
