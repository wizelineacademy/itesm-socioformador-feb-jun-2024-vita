...
const RecipesDetail = () => {
  ...
  const [recipe, setRecipe] = useState<Recipe>({
    ...
    description:
      'Un estofado reconfortante cargado de vegetales frescos y tiernos trozos de filete de res.',
    ingredients: [
      'Filete de res',
      'Papa',
      'Arroz',
    ...
    steps: [
      'Corta el filete de res en trozos pequeños y sazona al gusto con tus especias preferidas.',
      'En una olla grande, sofríe la cebolla hasta que esté transparente.',
      'Agrega los trozos de filete de res y cocina hasta que estén dorados por fuera.',
      'Incorpora las papas, zanahorias y arroz.',
      'Vierte el caldo de carne suficiente para cubrir los ingredientes y deja hervir.',
      'Reduce el fuego y cocina a fuego lento hasta que las verduras estén tiernas y el arroz esté cocido.',
      'Sirve caliente y disfruta de este reconfortante estofado.',
    ],
    time: '1 hora',
    mealtime: undefined,
  })
  ...
  return (
    <div className='ml-5 mr-5'>
      ...
      <div className='z-10 mt-2 flex w-full items-center space-x-5 sm:justify-end lg:w-11/12'>
        ...
        <div className='align-center z-10 flex flex-col text-center'>
          <h3 className='z-10 text-center text-lg font-semibold text-white'>
      ...
      <div className='mx-auto mt-5 flex w-full flex-col justify-between rounded-3xl bg-custom-purple5 px-10 pb-4 pt-3 lg:mt-10'>
        <h2 className='text-center text-2xl font-semibold text-white md:mb-2 md:mt-3 md:text-left'>
          Ingredientes
        </h2>
        <ul className='ml-5 mt-2 list-disc'>
          {recipe.ingredients.map((ingredient) => (
            <li className='my-1 text-white' key={ingredient}>
              {ingredient}
            </li>
          ))}
        </ul>
      ...
      <div className='mx-auto mb-5 mt-5 w-full px-5 lg:mt-10'>
        <h2 className='mt-2 text-center text-2xl font-semibold text-white md:mb-4 md:mt-5 md:text-left'>
          Preparación
        </h2>
        <ol className='list-decimal'>
          {recipe.steps.map((step) => (
            <li className='my-2 ml-2 leading-5 text-white' key={step}>
              {step}
            </li>
          ))}
        </ol>
      ...
      <div className='flex flex-col items-center md:items-start'>
        ...
        {loadingVideo && (
          <div className='mb-10'>
            <div role='status'>
              <svg
                aria-hidden='true'
                className='h-10 w-10 animate-spin fill-custom-purple5 text-gray-200 dark:text-gray-600'
                viewBox='0 0 100 101'
                fill='none'
        ...
        {!loadingVideo && errorVideo && (
          <p className='text-md mt-4 pl-2 text-left text-white md:mb-4 md:mt-2 md:pl-0'>
            No pudimos encontrar un video para esta receta
          </p>
        )}
        ...
        {!loadingVideo && !errorVideo && video && (
          <>
            <p className='text-md mt-4 pl-2 text-left text-white md:mb-4 md:mt-2 md:pl-0'>
              Te mostramos un video similar a la receta, toma en cuenta que
